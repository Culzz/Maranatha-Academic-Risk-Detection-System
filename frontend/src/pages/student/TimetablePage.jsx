/**
 * Student TimetablePage — View class timetable, exam timetable, and academic calendar.
 */
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-base text-slate-500">Your class schedule, exam timetable, and academic calendar</p>
      </div>
      ...
      <section>
        ...
        {classEntries.length === 0 ? (
          <div className="bg-white border border-slate-200 rounded-xl p-8 text-center">
            ...
            <p className="text-slate-500">Your class timetable has not been published yet</p>
          </div>
        ) : (
      ...
      <section>
        ...
        {examEntries.length === 0 ? (
          <div className="bg-white border border-slate-200 rounded-xl p-8 text-center">
            ...
            <p className="text-slate-500">Your exam timetable has not been published yet</p>
          </div>
        ) : (
      ...
      <section>
        ...
        {calendarEvents.length === 0 ? (
          <div className="bg-white border border-slate-200 rounded-xl p-8 text-center">
            ...
            <p className="text-slate-500">No academic calendar events have been published yet</p>
          </div>
        ) : (
